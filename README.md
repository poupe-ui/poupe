...
|---------|---------|-------------|
| [@poupe/color](./packages/@poupe-color) | [![npm version](https://img.shields.io/npm/v/@poupe/color.svg)](https://www.npmjs.com/package/@poupe/color) | Material Design 3 Recipe → Theme resolution |
