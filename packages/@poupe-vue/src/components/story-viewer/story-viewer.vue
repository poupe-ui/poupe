...
const storyModules = import.meta.glob(['../*.story.vue', '../*/*.story.vue']);
const storySourceModules = import.meta.glob(['../*.story.vue', '../*/*.story.vue'], { as: 'raw' });
...
const stories = computed(() => {
  return Object.keys(storyModules).map((path) => {
    // Extract name from paths like "../button.story.vue" or "../input/input.story.vue"
...
<template>
  <div class="flex h-full">
    <!-- Sidebar -->
    <aside class="w-64 border-r bg-lowest overflow-y-auto">
      <div class="p-4">
      ...
      >
        ...
        <div class="border-b p-4 flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            ...
            >
              <Icon icon="heroicons:code-bracket" class="mr-2" />
            ...
            <Suspense>
              ...
              <template #fallback>
                <div class="flex items-center justify-center p-8">
                  <Icon icon="spinner" class="text-2xl mr-2" />
                  <p>Loading story...</p>
                </div>
              </template>
            </Suspense>
