...
- Re-exported type `StandardDynamicSchemeKey` renamed to
  `DynamicSchemeKey`, tracking the upstream rename in
  `@poupe/theme-builder`. `ThemeOptions.scheme` and
  `defaultThemeScheme` widen to include `'cmf'`.
