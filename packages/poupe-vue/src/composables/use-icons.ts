...
const blankIcon: IconifyIcon = {
  body: '',
  width: 24,
  height: 24,
};

const unknownIcon: IconifyIcon = {
...
const globalIcons = reactive<{ poupe: Record<IconNames, IconifyIcon | string> } & Record<string, Record<string, IconifyIcon | string>>>({
  poupe: defaultIcons,
});

const registerIcons = (namespace: string, icons: Record<string, IconifyIcon | string>) => {
